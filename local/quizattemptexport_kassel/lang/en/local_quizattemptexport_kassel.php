...
$string['postprocessing_addedstr_answerdeleted'] = 'Answer deleted';
$string['postprocessing_addedstr_answerinvalid'] = 'Answer invalid';
...
$string['quizattemptexport_kassel:viewpdf'] = 'View/download PDF - Required for viewing the interface and download of files';
$string['quizattemptexport_kassel:generatepdf'] = 'Export PDF - Required for manual PDF export';
